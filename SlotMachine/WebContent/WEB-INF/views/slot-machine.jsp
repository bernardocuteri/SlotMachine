	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-sm-4 col-xs-2">
				<img class="img-responsive" src="resources/${number.n1 }.png">
			</div>
			<div class="col-sm-4 col-xs-2">
				<img class="img-responsive" src="resources/${number.n2 }.png"
					alt="Chania">
			</div>
			<div class="col-sm-4 col-xs-2">
				<img class="img-responsive" src="resources/${number.n3 }.png"
					alt="Chania">
			</div>
		</div>
